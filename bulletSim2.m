function [t,VAR,Output] = bulletSim2
%===========================================================================
% File: bulletSim2.m created May 12 2019 by MotionGenesis 5.9.
...
if( isempty(Output) ),
   if( ~isempty(FileIdentifier) ),
      ...
      fprintf( 1, '\n Output is in the file bulletSim2.1\n\n' );
   end
...
if( isempty(hasHeaderInformationBeenWritten) ),
   ...
   if( shouldPrintToFile && isempty(FileIdentifier) ),
      FileIdentifier(1) = fopen('bulletSim2.1', 'wt');   if( FileIdentifier(1) == -1 ), error('Error: unable to open file bulletSim2.1'); end
      fprintf(FileIdentifier(1), '%% FILE: bulletSim2.1\n%%\n' );
...
%===================================
end    % End of function bulletSim2
%===================================
