function [t,VAR,Output] = KaneExam_p1
%===========================================================================
% File: KaneExam_p1.m created May 07 2019 by MotionGenesis 5.9.
...
if( isempty(Output) ),
   if( ~isempty(FileIdentifier) ),
      ...
      fprintf( 1, '\n Output is in the file KaneExam_p1.1\n' );
      ...
      fprintf( 1, '    someName = load( ''KaneExam_p1.1'' );\n' );
...
if( isempty(hasHeaderInformationBeenWritten) ),
   ...
   if( shouldPrintToFile && isempty(FileIdentifier) ),
      FileIdentifier(1) = fopen('KaneExam_p1.1', 'wt');   if( FileIdentifier(1) == -1 ), error('Error: unable to open file KaneExam_p1.1'); end
      fprintf(FileIdentifier(1), '%% FILE: KaneExam_p1.1\n%%\n' );
...
%====================================
end    % End of function KaneExam_p1
%====================================
