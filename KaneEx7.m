function [t,VAR,Output] = KaneEx7
%===========================================================================
% File: KaneEx7.m created May 07 2019 by MotionGenesis 5.9.
...
Q1                              =  .262;                   % UNITS               Initial Value
Q2                              =  .524;                   % UNITS               Initial Value
...
COEF = zeros( 2, 2 );
COEF(1,1) = -Iz - 4*Mb*L^2 - Ma*L^2;
COEF(1,2) = -2*Mb*L^2*cos(Q1-Q2);
COEF(2,1) = -2*Mb*L^2*cos(Q1-Q2);
COEF(2,2) = -Iz - Mb*L^2;
RHS = zeros( 1, 2 );
RHS(1) = -L*(K*L*cos(Q1)*(-2+L/sqrt(-L^2*(-6.25+4*cos(Q1)+4*cos(Q2)-sin(Q1)-sin(Q2)-2*cos(Q1-Q2))))-Ma*g*sin(Q1)-2*K*L*sin(Q1-Q2)*(  ...
-2+L/sqrt(-L^2*(-6.25+4*cos(Q1)+4*cos(Q2)-sin(Q1)-sin(Q2)-2*cos(Q1-Q2))))-2*sin(Q1)*(Mb*g-2*K*L*(-2+L/sqrt(-L^2*(-6.25+4*cos(Q1)+  ...
4*cos(Q2)-sin(Q1)-sin(Q2)-2*cos(Q1-Q2)))))-2*Mb*L*sin(Q1-Q2)*U2^2);
RHS(2) = L*(Mb*g*sin(Q2)-4*K*L*sin(Q2)*(-2+L/sqrt(-L^2*(-6.25+4*cos(Q1)+4*cos(Q2)-sin(Q1)-sin(Q2)-2*cos(Q1-Q2))))-K*L*cos(Q2)*(-2+  ...
L/sqrt(-L^2*(-6.25+4*cos(Q1)+4*cos(Q2)-sin(Q1)-sin(Q2)-2*cos(Q1-Q2))))-2*K*L*sin(Q1-Q2)*(-2+L/sqrt(-L^2*(-6.25+4*cos(Q1)+4*cos(Q2)-  ...
sin(Q1)-sin(Q2)-2*cos(Q1-Q2))))-2*Mb*L*sin(Q1-Q2)*U1^2);
...
if( isempty(Output) ),
   if( ~isempty(FileIdentifier) ),
      ...
      fprintf( 1, '\n Output is in the file KaneEx7.1\n' );
      ...
      fprintf( 1, '    someName = load( ''KaneEx7.1'' );\n' );
...
if( isempty(hasHeaderInformationBeenWritten) ),
   ...
   if( shouldPrintToFile && isempty(FileIdentifier) ),
      FileIdentifier(1) = fopen('KaneEx7.1', 'wt');   if( FileIdentifier(1) == -1 ), error('Error: unable to open file KaneEx7.1'); end
      fprintf(FileIdentifier(1), '%% FILE: KaneEx7.1\n%%\n' );
